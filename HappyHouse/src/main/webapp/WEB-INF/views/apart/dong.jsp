...
<%@ include file="/WEB-INF/header.jsp" %>
  ...
  <section class="py-5">
    <div class="container">
      ...
      <form method="post" action="${pageContext.request.contextPath}/apart/dong.do">
         <h3>검색하실 동 이름을 입력해주세요</h3>
         <input type="text" name="dong" id="dong" style="border-radius:6px; border:1px solid;" />
         ...
         <c:choose>
    		...
    		<tbody>
               ...
               <form method="post">
            		...
            		formaction="${pageContext.request.contextPath}/apart/dong_sort.do?dong=${dong}"/><br><br>
            	</form>
